...
import { Card, Space, Form, Input, Select, Button, Table, Modal, message } from 'antd';
...
export default function (): ReactElement {
    const [examineModalVisible, setExamineModalVisible] = useState<boolean>(false);
    ...
    return (
        <Space direction='vertical' className='flex w-full'>
            <Card title='demo'>
                <Form layout='inline'>
                    <Space wrap align='start'>
                        <Form.Item label='查询'>
                            <Input style={{ width: 175 }} placeholder='请输入事务ID'></Input>
                        </Form.Item>
                        <Form.Item label='账户'>
            ...
            <Card>
                ...
                <Table dataSource={dataSource} columns={tenantTableColumns}></Table>
            </Card>
            <Modal
                width={400}
